...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="top_winners.php">Back to Top Winners page</a>
      </li>
...
$(document).ready(function () {
    ...
    echo "<h1>" . $person_name . " " . $person_surname . "</h1>";
    echo "<br><br>";
    ?>
<table id="example" class="display" style="width:100%">
       ...
       foreach($results as $result)
       {
           ...
           {
               if ($result["name"] == $person_name && $result["surname"] == $person_surname && $result["id"] == $placement["person_id"])
               {
               foreach($games as $game)
               {
               if ($game["id"] == $placement["games_id"])
               echo "<tr><td>" . $game["year"] . "</td><td>" . $game["country"] . "</td><td>" . $game["type"] . "</td><td>". $placement["discipline"] . "</td><td>" . $placement["placing"] . "</td></tr>";
